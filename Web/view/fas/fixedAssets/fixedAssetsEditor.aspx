<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fixedAssetsEditor.aspx.cs" Inherits="view_fas_fixedAssetsEditor" %>
        ...
        <div>
            <div class="tks-tbcolumn33">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="txtStartUseDate" class="layui-input laydate-icon " style="height: 38px"
                            value="{{:~YearMonthDay(StartUseDate)}}" name="StartUseDate" lay-verify="required">
                    </div>
            ...
            <div class="tks-tbcolumn33">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select id="selAssetsClass" name="AssetsClass">
        ...
        <div>
            <div class="tks-tbcolumn33">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select id="selDepreciationMethod" name="DepreciationMethod">
...
<%--                    <div class="layui-input-block">
            ...
            <div class="tks-tbcolumn33">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select id="selIsStartPeriodDepreciation" name="IsStartPeriodDepreciation">
    ...
    <script id="tpl-read" type="text/x-jsrender">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 10px;">
            <legend>基本信息</legend>
        </fieldset>
        <div>
            <div class="tks-tbcolumn33">
                <div class="layui-form-item">
                    <label class="layui-form-label">资产编号</label>
                    <div class="layui-input-block">
                        <input type="text" class="layui-input  layui-disabled" disabled value="{{:DocNo}}" name="DocNo" lay-verify="required" placeholder="">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">资产名称</label>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">开始使用日期</label>
                    <div class="layui-input-inline">
                        <input type="text" id="txtStartUseDate" class="layui-input laydate-icon layui-disabled" disabled style="height: 38px"
                            value="{{:~YearMonthDay(StartUseDate)}}" name="StartUseDate" lay-verify="required">
                    </div>
            ...
            <div class="tks-tbcolumn33">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-disabled">
                        <select id="selAssetsClass" disabled name="AssetsClass">
                            <option value="001">001 房屋、建筑物</option>
                            <option value="002">002 机器机械生产设备</option>
                            <option value="003">003 器具、工具、家具</option>
                            <option value="004">004 运输工具</option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input name="UseDeptName" value="{{:UseDeptName}}" class="layui-input layui-disabled"  disabled/>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">增加方式</label>
                    <div class="layui-input-block layui-disabled">
                        <select id="selAddType" disabled name="AddType">
            ...
            <div class="tks-tbcolumn33">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">规格型号</label>
                    <div class="layui-input-block">
                        <input name="SpecificationType" value="{{:SpecificationType}}" class="layui-input layui-disabled"  disabled/>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">供应商</label>
                    <div class="layui-input-block">
                        <input name="Supplier" value="{{:Supplier}}" class="layui-input layui-disabled" disabled />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="tks-tbcolumn33">
                <div class="layui-form-item">
                    <label class="layui-form-label">折旧方法</label>
                    <div class="layui-input-block layui-disabled">
                        <select id="selDepreciationMethod" disabled name="DepreciationMethod">
...
<%--                    <div class="layui-input-block">
                        <input class="layui-hide layui-disabled" name="ADSubjectName" value="累计折旧" />
                        <select name="ADSubjectCode" disabled>
            ...
            <div class="tks-tbcolumn33">
                <div class="layui-form-item">
                    <label class="layui-form-label">录入当期是否折旧</label>
                    <div class="layui-input-block layui-disabled">
                        <select id="selIsStartPeriodDepreciation" disabled name="IsStartPeriodDepreciation">
                            <option value="0">否</option>
                            <option value="1">是</option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input id="txtDCostSubjectName" type="text" class="layui-input  layui-disabled " disabled value="{{:DCostSubjectName}}" name="DCostSubjectName" lay-verify="required" />
                    </div>
            ...
            <div class="tks-tbcolumn33">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-disabled">
                        <input class="layui-hide" name="AssetImpairmentSubjectName" value="固定资产清理" />
                        <select name="AssetImpairmentSubjectCode" disabled>
        ...
        <div>
            <div class="tks-tbcolumn33">
                <div class="layui-form-item">
                    <label class="layui-form-label">资产原值</label>
                    <div class="layui-input-block">
                        <input id="txtInitialAssetValue" name="InitialAssetValue" value="{{:InitialAssetValue}}" lay-verify="required" class="layui-input layui-disabled" disabled />
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">预计使用月份</label>
                    <div class="layui-input-block">
                        <input id="txtPreUseMonth" name="PreUseMonth" value="{{:PreUseMonth}}" lay-verify="required" class="layui-input layui-disabled"  disabled/>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">累计折旧</label>
                    <div class="layui-input-block">
                        <input id="txtAccumulativeDpre" name="AccumulativeDpre" value="{{:AccumulativeDpre}}" lay-verify="required" class="layui-input layui-disabled" disabled />
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">每月折旧额</label>
            ...
            <div class="tks-tbcolumn33">
                <div class="layui-form-item">
                    <label class="layui-form-label">残值率%</label>
                    <div class="layui-input-block">
                        <input id="txtScrapValueRate" name="ScrapValueRate" value="{{:ScrapValueRate}}" class="layui-input layui-disabled"  disabled/>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">已折旧月份</label>
                    <div class="layui-input-block">
                        <input id="txtDpreMonth" name="DpreMonth" value="{{:DpreMonth}}" class="layui-input layui-disabled"  disabled/>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">本年累计折旧</label>
                    <div class="layui-input-block">
                        <input id="txtAccumulativeDpre_Y" name="AccumulativeDpre_Y" value="{{:AccumulativeDpre_Y}}" class="layui-input layui-disabled" disabled />
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">固定资产科目</label>
                    <div class="layui-input-block">
                        ...
                        <input id="txtGDName" type="text" class="layui-input   layui-disabled" value="{{:GDName}}" name="GDName" lay-verify="required" disabled/>
                    </div>
            ...
            <div class="tks-tbcolumn33">
                ...
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label">进项税额</label>
                    <div class="layui-input-block">
                        <input id="txtInputVAT" name="InputVAT" value="{{:InputVAT}}" class="layui-input layui-disabled"   disabled />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" src="fixedAssetsEditor.js?_=20181207"></script>
</body>
</html>
