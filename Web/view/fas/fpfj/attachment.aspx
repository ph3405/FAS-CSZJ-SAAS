...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var _url = 'http://localhost:8080';//API本地测试
            // var _url = 'https://api.zhangxiaosuan.com';//API
            var invoiceId = getQueryString('id');
            var token = getQueryString('token');
            $("#uploadify").uploadifive({
                'formData': { 'invoiceId': invoiceId,'token':token },
                ...
                'uploadScript': _url+'/fas/fp/UploadFile',//指定处理页面 
