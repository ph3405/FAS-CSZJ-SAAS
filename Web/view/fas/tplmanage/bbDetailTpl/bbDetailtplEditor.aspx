<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bbDetailtplEditor.aspx.cs" Inherits="view_bbDetailtplEditor" %>
...
<body class="childrenBody">
        ...
        <script id="tpl-editor" type="text/x-jsrender">
               <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="text" id="txtId" class="layui-input  layui-disabled" disabled value="{{:Id}}" name="Id" lay-verify="required" placeholder="" />
    ...
    <script type="text/javascript" src="bbDetailtplEditor.js"></script>
</body>
</html>
