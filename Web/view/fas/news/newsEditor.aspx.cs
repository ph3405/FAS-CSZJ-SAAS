...
public partial class view_fas_newsEditor : BasePage
{
    ...
    private void LoadData(string id)
    {
        ...
        this.txtSummary.Value = data.summary;
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            data.summary = this.txtSummary.Value;
            data.status = decimal.Parse(this.selStatus.Value);
