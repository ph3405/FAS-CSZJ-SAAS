<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customerList.aspx.cs" Inherits="view_fas_customerList" %>
...
<body class="childrenBody layui-form">
    <blockquote class="layui-elem-quote ">
        ...
        <div class="layui-inline">
            <a id="btnAdd" class="layui-btn layui-btn-normal ">增加客户</a>
    ...
    <script type="text/javascript" src="customerList.js?_=20181015"></script>
</body>
</html>
