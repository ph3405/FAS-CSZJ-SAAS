<%@ Page Language="C#" AutoEventWireup="true" CodeFile="balAccount.aspx.cs" Inherits="view_balAccount" %>
...
<%--        <div class="layui-input-inline" style="width: 100px;">
        ...
        <input type="checkbox" name="" title="辅助核算" lay-skin="primary" lay-filter="IsFuZhu" />
        <div class="layui-inline">
    ...
    <script id="tpl-print" type="text/x-jsrender">
        ...
        <table id="tb" style="border: 1.5px solid #000000" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td style="text-align :left">合 计</td>
                ...
                <td style="text-align:right;border-right:none">2000</td>
            </tr>
        </tfoot>--%>
        </table>
    ...
    <script type="text/javascript" src="balAccount.js?v=20181126"></script>
</body>
</html>
