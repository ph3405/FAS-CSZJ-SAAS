<%@ Page Language="C#" AutoEventWireup="true" CodeFile="calDetailAccount.aspx.cs" Inherits="view_calDetailAccount" %>
...
<%--        <div class="layui-input-inline" style="width: 100px;">
            <select id="selPeriodS" name="periodS" lay-filter="periodS">
                <option value="">选择期间</option>
        ...
        <div class="layui-input-inline" style="width: 100px;">
            <select id="selPeriodE" name="periodE" lay-filter="periodE">
                <option value="">选择期间</option>
        ...
        <%--<div class="layui-inline" style="width: 150px;">
            <select id="selCalItem" lay-filter="calItem">
                <option value="">辅助核算项</option>

            </select>
        </div>--%>
      <%--  <div class="layui-input-inline" style="width: 150px;">
            <select id="selCalItemMore" name="calItemMore" lay-filter="calItemMore">
                <option value="">辅助核算项</option>

            </select>
        </div>--%>
        <%--<div class="layui-inline" style="width: 150px;">
            <select id="selCalValue" lay-filter="calValue">
                <option value="">辅助核算内容</option>

            </select>
        </div>--%>
        <%--<div class="layui-input-inline" style="width: 150px;">
            <select id="selCalValMore" name="calValMore" lay-filter="calValMore">
                <option value="">核算项内容</option>
            ...
            <div class="layui-search-body">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-inline">年</div>
                        <div class="layui-inline" style="width: 70px;">
                            <select id="selMonthS" name="selMonthS" lay-filter="selMonthS">
                                <option value=""></option>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-inline">年</div>
                        <div class="layui-inline" style="width: 70px;">
                            <select id="selMonthE" name="selMonthE" lay-filter="selMonthE">
                                <option value=""></option>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">辅助核算项</label>
                        <div class="layui-input-inline" style="width: 150px;">
                            <select id="selCalItemMore" name="calItemMore" lay-filter="calItemMore">
                                <option value="">辅助核算项</option>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label">辅助核算项内容</label>
                        <div class="layui-input-inline" style="width: 150px;">
                            <select id="selCalValMore" name="calValMore" lay-filter="calValMore">
                                <option value="">核算项内容</option>
...
<%--            <div class="layui-search-footer">
    ...
    <script id="tpl-calValue" type="text/x-jsrender">
        <option data-title="{{:Value}}" value="{{:Code}}" {{if Code==001}} selected {{/if}}>{{:Value}}</option>
    </script>
    ...
    <script id="tpl-print" type="text/x-jsrender">
        ...
        <table style="width: 710px;">
            <tr style="height: 30px;">
                ...
                <td style="font-size: 20px; text-align: center; font-weight: 400">核算项目明细账</td>
                <td style="font-size: 12px; width: 33.3333%; text-align: right"></td>
            </tr>
            <tr style="height: 30px;">
                <td style="font-size: 12px; width: 33.3333%">{{:CalItem}}</td>
        ...
        <table style="width: 710px; font-size: 12px; height: 40px;">
            <tr>
    ...
    <script type="text/javascript" src="caldetailAccount.js?_=20180927"></script>
</body>
</html>
