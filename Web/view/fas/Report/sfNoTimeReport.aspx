<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sfNoTimeReport.aspx.cs" Inherits="view_sfNoTimeReport" %>
...
<%--                <a class="layui-btn layui-btn-mini tks-rowEdit" data-id="{{:    Id}}"><i class="layui-icon">&#xe642;</i>编辑</a>
    ...
    <script type="text/javascript" src="sfNoTimeReport.js?v=20180919"></script>
</body>
</html>
