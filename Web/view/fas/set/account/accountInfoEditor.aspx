<%@ Page Language="C#" AutoEventWireup="true" CodeFile="accountInfoEditor.aspx.cs" Inherits="view_fas_set_account_accountInfoEditor" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<body class="childrenBody">
        ...
        <script id="tpl-Edit" type="text/x-jsrender">
             ...
             <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="text" id="txtTrueName" class="layui-input   layui-disabled" disabled value="{{:TrueName}}" name="TrueName" lay-verify="required" placeholder="请选择会计">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block  layui-disabled">
                    <select name="IsNeedReviewed" disabled>
                ...
                <div class="layui-form-item" style="display:none">
                       ...
                       <%-- <a id="btnInvitation" class="layui-btn"   >邀请</a>--%>
                    </div>
            ...
            <div class="tks-tbcolumn50">
                ...
                <div class="layui-input-block">
                   <input  id="txtStartYearMonth"  class="layui-input  layui-disabled"  name="StartYearMonth"   disabled value="{{:~YearMonth(StartYearMonth)}}" >
                </div>
            </div>
             ...
             <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input"   value="{{:QY_CreditCode}}" name="QY_CreditCode" lay-verify="" placeholder="">
                </div>
            </div>
              <div class="layui-form-item">
                <label class="layui-form-label">会计准则</label>
                <div class="layui-input-block layui-disabled">
                    <select name="AccountantRule"   disabled>
    ...
    <script type="text/javascript" src="accountInfoEditor.js?_=20180806"></script>
</body>
</html>
