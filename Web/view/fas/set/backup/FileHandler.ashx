    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            if (file != null)
            {
                ...
                //var dt = ExcelToDataTable("TKS_FAS_YearPeriodInfo", true, file);

                AccountSetBLL bll = new TKS.FAS.BLL.FAS.AccountSetBLL();
                ...
                if (!Directory.Exists(uploadPath))
                {
                  ...
                  uploadPath += file.FileName;
                    bll.ImportBack(user.Token,file.FileName,uploadPath,file.ContentLength.ToString());
