...
<body>
    <form id="form1" runat="server">
        ...
        <blockquote class="layui-elem-quote ">
            ...
            <div class="layui-inline">
                <a id="btnDownload" href="../../../../excelTemp/辅助核算导入模板.xls" class="layui-btn  layui-btn-primary">下载模板</a>
            </div>
    ...
    <script>
        layui.config({
            ...
            $("#uploadify").uploadifive({
                ...
                'uploadScript': 'FileHandler.ashx?itemId=' +  getQueryString("itemId"),//指定处理页面 
