<%@ Page Language="C#" AutoEventWireup="true" CodeFile="calHelperEditor.aspx.cs" Inherits="view_fas_set_account_calHelperEditor" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
<body class="childrenBody">
    <form id="editForm" class="layui-form" style="width: 80%;">
          <script id="tpl-Edit" type="text/x-jsrender">
            <div class="layui-form-item">
                ...
                <div class=" layui-input-inline">
                    <input type="text" class="layui-input " {{if IsUse==1}} disabled{{/if}} value="{{:Title}}" name="Title" lay-verify="required" placeholder="">
                </div>
            </div>
            <div class="layui-form-item">
     ...
     <script id="tpl-col" type="text/x-jsrender">
        <div class="layui-input-inline {{:code}}">
            <input type="text" class="layui-input"  {{if IsUse==1}} disabled{{/if}}  lay-verify="required" value="{{:field}}" />
        </div>
    ...
    <script type="text/javascript" src="calHelperEditor.js"></script>
</body>
</html>
