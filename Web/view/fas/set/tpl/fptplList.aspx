...
<body class="childrenBody">
    ...
    <script id="tpl-list" type="text/x-jsrender">
        <tr>
            ...
            <td>{{if PayMode==0}} 现金 {{else}} 转账 {{/if}}</td>
           
 
            <td>
              
                <a class="layui-btn layui-btn-mini tks-rowEdit" data-id="{{:TPLID}}"><i class="layui-icon">&#xe642;</i>编辑模板</a>
    ...
    <script type="text/javascript" src="fptplList.js"></script>
</body>
</html>
