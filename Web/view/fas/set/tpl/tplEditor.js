        ...
        this.getData = function () {
            ...
            $(ed).find('tr').each(function (index) {
                ...
                try {
                    ...
                    data.Money_Debit = $(this).find('.DebitMoney')[0].value;
                    data.Money_Credit = $(this).find('.CreditMoney')[0].value;
                    checkRowData(data);
                    saveData.push(data);
                } catch (e) {
