<%@ Page Language="C#" AutoEventWireup="true" CodeFile="subjectAddForPz.aspx.cs" Inherits="view_fas_set_account_subjectAddForPz" %>
    ...
    <form id="editForm" class="layui-form" style="width: 100%;">
        <script id="tpl-Edit" type="text/x-jsrender">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select  id="selSubject"  lay-filter="currentAccount" lay-verify="required"  lay-search="">
            ...
            <div class="tks-tbcolumn50">
                ...
                <div class="layui-input-block">
                    <select id="selCreditDebit" name="Credit_Debit">
 ...
 <input type="checkbox" name="IsCurrencyValid" lay-skin="switch" {{if IsCurrencyValid==1}} checked {{/if}}>
            ...
            <div class="layui-form-item">
                ...
                <div id="currencyContainer" name="Currency" class="layui-input-block">
                  <input type="checkbox" name="currency-{{:Id}}"   title="{{:Name}}" />
                </div>
            </div>
            ...
            <div class="layui-form-item">
                  ...
                  <div id="calItemContainer"  class="layui-input-block">
                    <input type="checkbox" name="cal-{{:Id}}" title="{{:Title}}" />
                 </div>
            </div>
     ...
     <script id="tpl-currency" type="text/x-jsrender">
          <input type="checkbox" name="currency-{{:Id}}" {{if IsBaseCurrency==1}} checked disabled {{/if}} title="{{:Name}}" />
    </script>
    <script id="tpl-calItem" type="text/x-jsrender">
          <input type="checkbox" name="cal-{{:Id}}" title="{{:Title}}" />
    </script>
    <script id="tpl-select" type="text/x-jsrender" >
        <option value="{{:Id}}" >{{:Code}}  {{:ShowTitle}}</option>
    </script>
    <script>
        var token = '<%=Token%>';
    </script>
    ...
    <script type="text/javascript" src="subjectAddForPz.js?v=20180831"></script>
</body>
</html>
