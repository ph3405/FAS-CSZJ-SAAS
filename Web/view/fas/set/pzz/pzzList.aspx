<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pzzList.aspx.cs" Inherits="view_fas_set_pzzList" %>
...
<body class="childrenBody">
    <blockquote class="layui-elem-quote ">
        ...
        <div class="layui-inline">
            <a id="btnAdd" class="layui-btn layui-btn-normal "><i class="layui-icon">&#xe654;</i>新增凭证字</a>
        </div>
    ...
    <script id="tpl-list" type="text/x-jsrender">
        <tr>
            ...
            <td>{{if IsDefault==1}} 是 {{else}} 否 {{/if}} </td>
    ...
    <script type="text/javascript" src="pzzList.js"></script>
</body>
</html>
