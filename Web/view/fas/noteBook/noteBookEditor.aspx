<%@ Page Language="C#" AutoEventWireup="true" CodeFile="noteBookEditor.aspx.cs" Inherits="view_fas_noteBookEditor" ValidateRequest="false" %>
...
<body class="childrenBody">
    <form runat="server" class="layui-form" style="width: 100%;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input id="txtSort" type="text" runat="server" class="layui-input"  value="{{:Sort}}" lay-verify="number"  placeholder="请输入数字">
            </div>
        </div>
